...
sunset_tags = PictureTag.create({picture: sunset, tag: tagOne})
sunset_tags2 = PictureTag.create({picture: sunset, tag: tagTwo})
cabin_tags = PictureTag.create({picture: cabin, tag: tagOne})
cabin_tags2 = PictureTag.create({picture: cabin, tag: tagTwo})